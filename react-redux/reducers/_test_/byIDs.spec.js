import { changeItemBySearch } from '../byIDs';

describe('changeItemBySearch() function', () => {
    const byIDsState = {
        '1': {
            _id: 1,
    ...
    it('return EMPTY array if title, description does not contain the word', () => {
        expect(changeItemBySearch(byIDsState, 'wwwxxzzz')).toEqual([]);
    })
    it('return an array of items to display', () => {
        ...
        expect(changeItemBySearch(byIDsState, 'umbre')).toEqual(resultToCompare);
    })
})